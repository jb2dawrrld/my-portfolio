        ...
        <main>
          <div className='homepage-card'>
            <div className='profile flex flex-col md:flex-row items-center md:items-start'>
              <section>
                <img src={`${import.meta.env.BASE_URL}headshot2.jpg`} alt="Profile" className='profile-img w-200 h-200 sm:w-56 sm:h-56 md:w-64 md:h-64 rounded-full mx-auto md:mx-0'/>
              </section>
